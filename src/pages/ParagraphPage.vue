...
export default {
  ...
  methods: {
    loadParagraphContent() {
      ...
      const data = paragraphs[paragraphId] || { title: 'Content not found.', content: 'Content not found.', image: '' };
