	...
	<div>
		...
		<main>
			...
			>
				...
				<div v-if="isLoraHollidayAlbum" class="flex justify-center mt-8">
					<div>
...
export default {
	...
	data() {
		const albumInfo = {
			loraHolliday: {
				...
				spotifyUrl:
					"https://open.spotify.com/embed/album/7q0dHs3EZYLrydAKRktZ25",
			},
			loraHollidayLive: {
				...
				spotifyUrl:
					"https://open.spotify.com/embed/album/0hxxD23r5fQbRGeyHa3QSE",
			},
		};
	...
	computed: {
		...
		otherAlbums() {
			...
			const otherAlbumKey =
				currentAlbum === "loraHolliday" ? "loraHollidayLive" : "loraHolliday";
		...
		isLoraHollidayAlbum() {
			return this.featuredAlbumData.title === 'PIRATI "Lora Holliday"';
		},
	},
	watch: {
		album(newAlbum) {
