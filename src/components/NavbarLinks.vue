<template>
  <div class="w-full flex flex-col md:flex-row justify-between items-center">
    ...
    <ul class="hidden md:flex md:px-4 md:mx-auto md:font-semibold md:font-heading md:space-x-4 lg:space-x-6 xl:space-x-12">
      ...
      <li class="relative" @mouseenter="showDropdown('about')" @mouseleave="hideDropdown('about')">
        ...
        <ul class="absolute dropdown-menu bg-[#0d1422] text-white font-semibold mt-2 w-48 z-10" :class="{ show: activeDropdown === 'about' }">
          <li>
            <a class="block w-full px-4 py-2 hover:bg-[#1a2630] dropdown-animation" href="/about">Sve o nama</a>
          </li>
          <li>
            <a class="block w-full px-4 py-2 hover:bg-[#1a2630] dropdown-animation" href="/paragraph/1">Piraterija i Piratstvo</a>
          </li>
          <li>
            <a class="block w-full px-4 py-2 hover:bg-[#1a2630] dropdown-animation" href="/paragraph/2">Prva Postava Grupe</a>
          </li>
          <li>
            <a class="block w-full px-4 py-2 hover:bg-[#1a2630] dropdown-animation" href="/paragraph/3">Prvi Nastup</a>
          </li>
          <li>
      ...
      <li class="relative" @mouseenter="showDropdown('albums')" @mouseleave="hideDropdown('albums')">
        <a class="animated-link" href="#" @click.prevent="toggleDropdown('albums')">Albums
          <svg class="w-6 h-6 ml-1 inline" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
            <path fill-rule="evenodd" d="M5.293 9.293a1 1 0 011.414 0L10 12.586l3.293-3.293a1 1 0 111.414 1.414l-4 4a1 1 0 01-1.414 0l-4-4a1 1 0 010-1.414z"
                  clip-rule="evenodd">
            </path>
        ...
        <ul class="absolute dropdown-menu bg-[#0d1422] text-white font-semibold mt-2 w-48 z-10" :class="{ show: activeDropdown === 'albums' }">
          <li>
            <router-link class="block w-full px-4 py-2 hover:bg-[#1a2630] dropdown-animation" :to="{ name: 'AlbumInfo', params: { album: 'loraHolliday' } }">
              Lora Holliday
            </router-link>
          </li>
          <li>
            <router-link class="block w-full px-4 py-2 hover:bg-[#1a2630] dropdown-animation"
                         :to="{ name: 'AlbumInfo', params: { album: 'loraHollidayLive' } }">Lora Holliday LIVE
            </router-link>
          </li>
        </ul>
      </li>
      ...
      <li
          class="relative"
          @mouseenter="showDropdown('NajvaznijiNastupi')"
          @mouseleave="hideDropdown('NajvaznijiNastupi')"
      >
        <a
            class="animated-link"
            href="#"
            @click.prevent="toggleDropdown('NajvaznijiNastupi')"
        >
          Najvažniji nastupi
          <svg
      ...
      <!-- Video -->
      <li class="relative" @mouseenter="showDropdown('Video')" @mouseleave="hideDropdown('Video')">
        <a class="animated-link" href="/video">Video</a>
      </li>
      ...
      <li class="relative" @mouseenter="showDropdown('gallery')" @mouseleave="hideDropdown('gallery')">
        ...
        <ul class="absolute dropdown-menu bg-[#0d1422] text-white font-semibold mt-2 w-48 z-10" :class="{ show: activeDropdown === 'gallery' }">
          <li>
            <a class="block w-full px-4 py-2 hover:bg-[#1a2630] dropdown-animation" href="#" @click.prevent="navigateToGallery('section-4')">Prva Postava</a>
          </li>
          <li>
            <a class="block w-full px-4 py-2 hover:bg-[#1a2630] dropdown-animation" href="#" @click.prevent="navigateToGallery('section-5')">Prvi Nastup</a>
          </li>
          <li>
            <a class="block w-full px-4 py-2 hover:bg-[#1a2630] dropdown-animation" href="#" @click.prevent="navigateToGallery('section-3')">Tiraž Rasprodat</a>
          </li>
          <li>
            <a class="block w-full px-4 py-2 hover:bg-[#1a2630] dropdown-animation" href="#" @click.prevent="navigateToGallery('section-1')">Section 1</a>
          </li>
          <li>
            <a class="block w-full px-4 py-2 hover:bg-[#1a2630] dropdown-animation" href="#" @click.prevent="navigateToGallery('section-2')">Section 2</a>
          </li>
        </ul>
      </li>
    ...
    <ul v-if="isMenuOpen" class="md:hidden absolute top-full right-0 w-full bg-[#0d1422]/80 text-white font-semibold z-50">
      ...
      <li>
        <a class="block w-full px-4 py-2 flex justify-between items-center hover:bg-[#1a2630] animated-link" href="#" @click.prevent="toggleDropdown('about')">
          About Us
          <svg class="w-6 h-6 ml-1 inline" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
            <path fill-rule="evenodd" d="M5.293 9.293a1 1 0 011.414 0L10 12.586l3.293-3.293a1 1 0 111.414 1.414l-4 4a1 1 0 01-1.414 0l-4-4a1 1 0 010-1.414z"
                  clip-rule="evenodd">
      ...
      <li>
        <a class="block w-full px-4 py-2 flex justify-between items-center hover:bg-[#1a2630] animated-link" href="#" @click.prevent="toggleDropdown('albums')">Albums
          <svg class="w-6 h-6 ml-1 inline" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
            <path fill-rule="evenodd" d="M5.293 9.293a1 1 0 011.414 0L10 12.586l3.293-3.293a1 1 0 111.414 1.414l-4 4a1 1 0 01-1.414 0l-4-4a1 1 0 010-1.414z"
                  clip-rule="evenodd">
            </path>
      ...
      <!-- Najvažniji nastupi -->
      <li>
        <a class="block w-full px-4 py-2 flex justify-between items-center hover:bg-[#1a2630] animated-link" href="#"
           @click.prevent="toggleDropdown('NajvaznijiNastupi')">
          Najvažniji nastupi
          <svg class="w-6 h-6 ml-1 inline" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
            <path fill-rule="evenodd" d="M5.293 9.293a1 1 0 011.414 0L10 12.586l3.293-3.293a1 1 0 111.414 1.414l-4 4a1 1 0 01-1.414 0l-4-4a1 1 0 010-1.414z"
      ...
      <!-- Contact for Mobile -->
      <li>
        <a class="block w-full px-4 py-2 hover:bg-[#1a2630] animated-link" href="#" @click.prevent="scrollToSection('contact')">Contact</a>
      </li>
    </ul>
